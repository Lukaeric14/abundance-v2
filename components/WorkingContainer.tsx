...
interface WorkingContainerProps {
  ...
  onActiveViewerChange?: (viewer: 's1' | 's2') => void
}
...
export default function WorkingContainer({ 
  ...
  useEffect(() => {
    ...
    console.log('WorkingContainer: projectStatus =', projectStatus, 'isGenerating =', projectStatus === 'generating')
  }, [projectStatus])
  ...
  return (
    <div className="project-container">
      ...
      <div className="project-content">
        {/* Header with Students Only (if teacher view) */}
        <div className="project-header">
          {showStudentSwitcher && (
            <div className="students-section">
              <button type="button" className="avatar-btn" onClick={() => onActiveViewerChange?.('s1')}>
              ...
              <button type="button" className="avatar-btn" onClick={() => onActiveViewerChange?.('s2')}>
